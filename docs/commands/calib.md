...
| `--cam-info <topic>`    | CameraInfo topic. When omitted, resolved from `--cam` using the same auto-resolution rules as [`movify cam`'s `--cam-info`](movify.md#bagwiz-movify-cam). A literal topic name, not a glob. Long-form only.                                                                                                                                                                                                                                                                                   |
