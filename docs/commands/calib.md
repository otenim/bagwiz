...
| `--cam-info <topic>`    | CameraInfo topic. When omitted, resolved from `--cam` using the same auto-resolution rules as [`movify`'s `--cam-info`](movify.md#options). A literal topic name, not a glob. Long-form only.                                                                                                                                                                                                                                                                                                 |
