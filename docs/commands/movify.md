...
| `--crf <n>`               | H.264 constant-quality target, `0` (best) to `51` (smallest); NVENC uses it as its constant-quality level. `.avi` (MJPEG) ignores it. Default: `23`. Long-form only.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `--gop <n>`               | H.264 keyframe interval in frames: every `n`-th frame is a keyframe a player can start or seek from. A smaller value seeks faster and costs bytes. Must be at least 1. `.avi` (MJPEG) ignores it. Default: `12`. Long-form only.                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `--scheme <scheme>`       | Color scheme for point coloring: `viridis`, `turbo`, `jet`, `plasma`, `inferno`, `magma`, `rainbow`. Default: `jet`. Long-form only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
`--crf` sets the quality target and `--gop` the keyframe interval, the same
knobs `video encode` takes.
