...
| [`bagwiz movify`](docs/commands/movify.md)     | Render a rosbag to video: camera panels (`--cam`) as a single view or a multi-view grid, with point clouds optionally projected onto them (`--cam-pcd`).                                                                                                                                                                                                                        |
