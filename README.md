...
| [`bagwiz generate`](docs/commands/generate.md) | Generate non-rosbag media from a rosbag — e.g. render image topics to a video (`video cam`), as a single view or a multi-view grid with per-view point-cloud overlays.                                                                                                                                                                                                          |
