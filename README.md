...
| [`bagwiz generate`](docs/commands/generate.md) | Generate non-rosbag media from a rosbag — render an image topic to a video (`video cam`), or a point-cloud topic's scan pattern to a firing-order animation (`video scan`).                                                                                                                                                                                                     |
