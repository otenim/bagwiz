...
| [`bagwiz movify`](docs/commands/movify.md)     | Render a rosbag to video: camera panels (`--cam`) and point-cloud panels (`--pcd`, in 3D and/or from above) composed into one grid, with point clouds optionally projected onto the camera panels (`--cam-pcd`).                                                                                                                                                                |
