...
| [`bagwiz du`](docs/commands/du.md)             | Report per-topic serialized payload sizes in a ROS 2 rosbag, du(1)-style: sorted by size descending, with a `total` row (human-readable sizes by default, `-b` for raw bytes).                                                                                                                                                                                                  |
