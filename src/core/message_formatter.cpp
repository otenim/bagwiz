...
bool is_primitive(std::uint8_t type_id) { return type_id != ts_types::ROS_TYPE_MESSAGE; }
...
{
public:
  MessageBuffer(const ts_types::MessageMembers & members) : members_(&members)
  {
    void * p = nullptr;
