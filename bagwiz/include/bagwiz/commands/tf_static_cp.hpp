...
// Implements `bagwiz tf static cp --src <src> --dst <dst> [-o <output>] [--force]
// [-w|--overwrite]`:
// copy every static TF topic (core::is_static_tf_topic: type
// tf2_msgs/msg/TFMessage with "tf_static" as the name's final path segment)
// from <src> into <dst>, preserving each topic's
