...
#ifndef BAGWIZ__CORE__TUI__INTERNAL__SIGNAL_HANDLER_HPP_
#define BAGWIZ__CORE__TUI__INTERNAL__SIGNAL_HANDLER_HPP_

#include <atomic>

namespace bagwiz::core::tui::internal
{
...
#endif  // BAGWIZ__CORE__TUI__INTERNAL__SIGNAL_HANDLER_HPP_
