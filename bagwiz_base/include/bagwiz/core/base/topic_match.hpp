...
// exact topic-name match. Used by every glob-capable topic slot declared
// through add_topic_option() (see bagwiz/commands/topic_option.hpp for how a
// slot opts in) to expand the user-supplied selectors (e.g. "/sensing/*",
// "*/image_raw", "*") against a bag's topic list.
//
